...
import com.example.gili.comutil.GalleryAppUtil;
...
public class BlogActivity extends AppCompatActivity {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode == 100 && grantResults.length>0){
            if(grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                CommonUtils.showLongMessage(BlogActivity.this, " no permission ");
            }
        }
    }
        ...
        if(requestCode == 20 && resultCode == RESULT_OK){
            if(data.getClipData() != null){
                ...
                for(int i=0;i<clipData.getItemCount();i++){
                    ...
                    }else if("external".equals(uri.getPathSegments())){
            ...
            String filePath = GalleryAppUtil.getSingleFilePath(this, data);
            insertImageToEditText(filePath);
        }
    }
    ...
    private void insertImageToEditText(String filePath) {
        if(!filePath.equals("")) {
            ...
            stringBuilder.setSpan(new ImageSpan(this, bitmap, ImageSpan.ALIGN_BASELINE), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
